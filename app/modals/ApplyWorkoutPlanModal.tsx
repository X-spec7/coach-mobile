...
import { WorkoutService, PublicWorkoutPlan, WeekDay } from '../services/workoutService';

interface ApplyWorkoutPlanModalProps {
  visible: boolean;
  onClose: () => void;
  workoutPlan: PublicWorkoutPlan | null;
  onSuccess: () => void;
}
...
export const ApplyWorkoutPlanModal: React.FC<ApplyWorkoutPlanModalProps> = ({
  visible,
  onClose,
  workoutPlan,
  onSuccess,
  ...
  const handleApply = async () => {
    ...
    if (isNaN(weeks) || weeks < 1 || weeks > 12) {
      Alert.alert('Validation Error', 'Please enter a valid number of weeks (1-12).');
      return;
    }
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Failed to apply workout plan';
        ...
        <View style={[styles.container, { backgroundColor: Colors[colorScheme ?? 'light'].background }]}>
          ...
          <ScrollView style={styles.content}>
            ...
            <View style={styles.planInfo}>
              ...
              <Text style={styles.planCreator}>by {workoutPlan.client_name}</Text>
              ...
              <View style={styles.planStats}>
                <View style={styles.statItem}>
                  ...
                  <Text style={styles.statText}>{workoutPlan.daily_plans_count} days</Text>
                </View>
                <View style={styles.statItem}>
                  <Ionicons name="flame" size={16} color="#A78BFA" />
                  <Text style={styles.statText}>{workoutPlan.total_calories} cal</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.weeksContainer}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    const current = parseInt(weeksCount) || 1;
                    if (current < 12) setWeeksCount((current + 1).toString());
                  }}
                >
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.sectionDescription}>
                When do you want to start this workout plan?
              </Text>
              <TouchableOpacity
            ...
            {selectedDays.length > 0 && (
              <View style={styles.summary}>
                ...
                <Text style={styles.summaryText}>
                  You'll have {getTotalWorkouts()} scheduled workouts over {weeksCount} weeks
                </Text>
                <Text style={styles.summaryText}>
                  Working out on: {selectedDays.map(day => 
